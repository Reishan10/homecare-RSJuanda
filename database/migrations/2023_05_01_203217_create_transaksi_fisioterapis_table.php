...
return new class extends Migration
{
    ...
    {
        Schema::create('transaksi_fisioterapi', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('fisioterapi_id');
            $table->foreign('fisioterapi_id')->references('id')->on('fisioterapi')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('transaksi_fisioterapi');
    }
};
