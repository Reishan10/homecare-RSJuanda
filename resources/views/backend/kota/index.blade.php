...
@section('content')
    ...
    <!-- kota modal -->
    <div id="kotaModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="kotaModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <form id="form">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" id="kotaModalLabel"></h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnTambah').click(function() {
                $('#id').val('');
                $('#kotaModalLabel').html("Tambah Kota");
            ...
            $('body').on('click', '#btnEdit', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#kotaModalLabel').html("Edit Kota");
                        $('#simpan').val("edit-kota");
                        $('#kotaModal').modal('show');
                        $('#name').removeClass('is-invalid');
                        $('.errorName').html('');
                        $('#id').val(response.id);
            ...
            $('#btnHapusBanyak').on('click', function(e) {
                ...
                if (idArr.length <= 0) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{ route('delete-multiple-kota') }}",
                                type: 'POST',
                                data: 'id=' + strId,
                                success: function(response) {
