                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="id" id="id" value="{{ $homecare->id }}">
                                        <input type="text" id="kode_homecare" name="kode_homecare" class="form-control"
                                            value="{{ $homecare->kode_homecare }}" readonly>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="kategori" id="kategori" class="form-control select2"
                                            ...
                                            @foreach ($kategori as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ $row->id == $homecare->kategori_id ? 'selected' : '' }}>
                                                    {{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="poli" id="poli" class="form-control select2"
                                            ...
                                            @foreach ($poli as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ $row->id == $homecare->poli_id ? 'selected' : '' }}>
                                                    {{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="bayar" id="bayar" class="form-control select2"
                                            ...
                                            @foreach ($bayar as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ $row->id == $homecare->bayar_id ? 'selected' : '' }}>
                                                    {{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="jasa_medis_dokter" id="jasa_medis_dokter"
                                            class="form-control" value="{{ $homecare->jasa_medis_dokter }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="total_biaya_dokter" id="total_biaya_dokter"
                                            class="form-control" value="{{ $homecare->total_biaya_dokter }}">
                                ...
                                <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" name="jasa_rumah_sakit" id="jasa_rumah_sakit"
                                                    class="form-control" value="{{ $homecare->jasa_rumah_sakit }}">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" name="menejemen" id="menejemen"
                                                    class="form-control" value="{{ $homecare->menejemen }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="jasa_medis_perawat" id="jasa_medis_perawat"
                                            class="form-control" value="{{ $homecare->jasa_medis_perawat }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="total_biaya_perawat" id="total_biaya_perawat"
                                            class="form-control" value="{{ $homecare->total_biaya_perawat }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="total_biaya_perawat_dokter"
                                            id="total_biaya_perawat_dokter" class="form-control"
                                            value="{{ $homecare->total_biaya_perawat_dokter }}">
