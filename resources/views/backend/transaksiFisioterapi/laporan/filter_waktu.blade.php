                    ...
                    <div class="card-body">
                        <div class="d-md-flex justify-content-between">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                {{-- <a href="{{ route('laporan-fisioterapi.exportExcel') }}"class="btn btn-secondary btn-sm ms-1"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnPrint').on('click', function() {
                ...
                var printContent =
                    '<table class="table"><thead><tr><th>No</th><th>Pasien</th><th>Perawat</th><th>Dokter</th><th>Fisioterapi</th><th>Waktu</th></tr></thead><tbody>';
