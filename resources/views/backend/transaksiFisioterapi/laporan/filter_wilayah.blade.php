    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('laporan-fisioterapi.wilayah') }}',
                    data: function(d) {
            ...
            $('#btnExportPDF').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route('laporan-fisioterapi.printPDFWilayah') }}',
                    type: 'GET',
                    data: {
                        provinsi: provinsi,
                        kabupaten: kabupaten,
            ...
            $('#btnExportExcel').click(function() {
                ...
                $.ajax({
                    url: '{{ route('laporan-fisioterapi.exportExcelWilayah') }}',
                    method: 'POST',
                    data: {
                        provinsi: provinsi,
                        kabupaten: kabupaten,
            ...
            $('#provinsi').on('change', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('laporan-fisioterapi.get-kabupaten') }}",
                    data: {
            ...
            $('#kabupaten').on('change', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('laporan-fisioterapi.get-kecamatan') }}",
                    data: {
            ...
            $('#kecamatan').on('change', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('laporan-fisioterapi.get-desa') }}",
                    data: {
