                        ...
                        <div class="d-md-flex justify-content-between">
                            <div class="d-flex align-items-center mb-3">
                                @if (auth()->user()->type != 'Pasien')
                                    <a href="{{ route('transaksi-homecare.printPDF') }}" class="btn btn-secondary btn-sm"
                                        id="btnExportPDF"> <i class="mdi mdi-file-pdf"></i> Export PDF</a>
                                    <a href="{{ route('transaksi-homecare.exportExcel') }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnPrint').on('click', function() {
                ...
                printWindow.document.write('<html><head><title>Print Transaksi Paket Homecare</title>');
