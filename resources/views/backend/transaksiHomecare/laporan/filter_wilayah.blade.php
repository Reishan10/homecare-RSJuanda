    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('laporan-paket-homecare.wilayah') }}',
                    data: function(d) {
            ...
            $('#btnExportPDF').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route('laporan-paket-homecare.printPDFWilayah') }}',
                    type: 'GET',
                    data: {
                        provinsi: provinsi,
                        kabupaten: kabupaten,
            ...
            $('#btnExportExcel').click(function() {
                ...
                $.ajax({
                    url: '{{ route('laporan-paket-homecare.exportExcelWilayah') }}',
                    method: 'POST',
                    data: {
                        provinsi: provinsi,
                        kabupaten: kabupaten,
            ...
            $('#provinsi').on('change', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('laporan-paket-homecare.get-kabupaten') }}",
                    data: {
            ...
            $('#kabupaten').on('change', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('laporan-paket-homecare.get-kecamatan') }}",
                    data: {
            ...
            $('#kecamatan').on('change', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('laporan-paket-homecare.get-desa') }}",
                    data: {
