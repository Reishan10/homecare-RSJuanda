...
@section('content')
                            ...
                            <div class="tab-pane show active" id="basic-preview">
                                <div class="d-md-flex justify-content-between">
                                    <div class="d-flex align-items-center mb-3">
                                        <a href="{{ route('jabatan.printPDF') }}" class="btn btn-secondary btn-sm"
                                            id="btnExportPDF"> <i class="mdi mdi-file-pdf"></i> Export PDF</a>
                                        <a href="{{ route('jabatan.exportExcel') }}" class="btn btn-secondary btn-sm ms-1"
    ...
    <!-- jabatan modal -->
    <div id="jabatanModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="jabatanModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <form id="form">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" id="jabatanModalLabel"></h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnPrint').on('click', function() {
                ...
                var printContent =
                    '<table class="table"><thead><tr><th>No</th><th>Kode Jabatan</th><th>Nama</th></tr></thead><tbody>';

                $.each(data, function(index, value) {
                    printContent += '<tr><td>' + (index + 1) + '</td><td>' + value.kode_jabatan +
                ...
                printWindow.document.write('<html><head><title>Print Jabatan</title>');
            ...
            $('#btnTambah').click(function() {
                $('#id').val('');
                $('#jabatanModalLabel').html("Tambah Data");
            ...
            $('body').on('click', '#btnEdit', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#jabatanModalLabel').html("Edit Data");
                        $('#simpan').val("edit-jabatan");
                        $('#jabatanModal').modal('show');
            ...
            $('#btnHapusBanyak').on('click', function(e) {
                ...
                if (idArr.length <= 0) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{ route('delete-multiple-jabatan') }}",
                                type: 'POST',
                                data: 'id=' + strId,
                                success: function(response) {
