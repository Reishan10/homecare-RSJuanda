...
@section('content')
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select class="form-control select2" data-toggle="select2"
                                                    ...
                                                    @foreach ($provinces as $row)
                                                        <option value="{{ $row->id }}"
                                                            {{ $dokter->user->provinsi_id == $row->id ? 'selected' : '' }}>
                                                            {{ $row->name }}</option>
                                                    @endforeach
                                                </select>
    ...
    <script>
        $(document).ready(function() {
            ...
            let provinsiId = {{ $dokter->user->provinsi_id ?? 'null' }};
            ...
            if (provinsiId) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        let kabupatenId = {{ $dokter->user->kabupaten_id ?? 'null' }};
