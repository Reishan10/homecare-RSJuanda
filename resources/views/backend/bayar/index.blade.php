                            ...
                            <div class="tab-pane show active" id="basic-preview">
                                <div class="d-md-flex justify-content-between">
                                    <div class="d-flex align-items-center mb-3">
                                        <a href="{{ route('bayar.printPDF') }}" class="btn btn-secondary btn-sm"
                                            id="btnExportPDF"> <i class="mdi mdi-file-pdf"></i> Export PDF</a>
                                        <a href="{{ route('bayar.exportExcel') }}" class="btn btn-secondary btn-sm ms-1"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnPrint').on('click', function() {
                ...
                var printContent =
                    '<table class="table"><thead><tr><th>No</th><th>Kode Bayar</th><th>Nama</th></tr></thead><tbody>';

                $.each(data, function(index, value) {
                    printContent += '<tr><td>' + (index + 1) + '</td><td>' + value.kode_bayar +
                ...
                printWindow.document.write('<html><head><title>Print Bayar</title>');
