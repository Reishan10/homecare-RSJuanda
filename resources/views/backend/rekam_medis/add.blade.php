    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{ route('rekam-medis.store') }}" method="post" id="form">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <textarea name="resep_obat" id="resep_obat" rows="2" class="form-control"></textarea>
                                            <div class="invalid-feedback errorResepObat">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <label for="catatan_tambahan" class="form-label">Catatan Tambahan</label>
                                            <textarea name="catatan_tambahan" id="catatan_tambahan" rows="2" class="form-control"></textarea>
